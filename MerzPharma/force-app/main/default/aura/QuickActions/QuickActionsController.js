({
    ...
    handleClick: function(cmp, event, helper) {
        ...
        cmp.find("navService").navigate({ 
            ...
            attributes: { 
                url: 'https://medtech1.my.salesforce.com/flow/Mark_Product_for_Order?ProductId=01tKB000001NpEKIAI&&LocationId=131KB000000kaCTIAC'
            } 
        });
        var urlEvent = $A.get("e.force:navigateToURL");
        urlEvent.setParams({
            "url": "/flow/Mark_Product_for_Order?ProductId=01tKB000001NpEKIAI&&LocationId=131KB000000kaCTIAC"
        });
        urlEvent.fire();*/
        var urlEvent = $A.get("e.force:navigateToURL");
        urlEvent.setParams({
        ...
        //urlEvent.fire();
        location.replace("/flow/Mark_Product_for_Order?ProductId=01tKB000001NpEKIAI&&LocationId=131KB000000kaCTIAC&retURL="+cmp.get("v.VisitId"))
    },
